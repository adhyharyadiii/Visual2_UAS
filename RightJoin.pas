...
begin
  ...
  begin
    ...
    zqry1.SQL.Add('order by hubungan.siswa_id, hubungan.ortu_id');
    zqry1.Open;
  end else
  ...
  begin
    ...
    zqry1.SQL.Add('order by riwayat_poin.siswa_id, riwayat_poin.ortu_id, riwayat_poin.wali_id, riwayat_poin.kelas_id, riwayat_poin.poin_id');
    zqry1.Open;
  end;
end;
